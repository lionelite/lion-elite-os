...
const STAGE_PROBABILITY = Object.freeze({
  ...
  reply_received: 0.15,
  qualified: 0.3,
  // Only a little above qualified: a booked call that has not happened yet is
  // worth barely more than the qualification that produced it, because
  // cold-booked calendars no-show heavily. Weighting a booking near an offer
  // would inflate the forecast with meetings nobody attended.
  meeting_booked: 0.35,
  // Held is the real jump — someone turned up and talked.
  meeting_held: 0.45,
  offer_sent: 0.5,
