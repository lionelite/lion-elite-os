 ...
 */
async function fetchBusinesses({ area, categories, endpoint = DEFAULT_ENDPOINT, fetchImpl = fetch, timeoutMs = 90000 } = {}) {
...
module.exports = { CATEGORIES, DEFAULT_ENDPOINT, buildQuery, parseBusinesses, fetchBusinesses };
