 ...
 */
async function composeCreative({ backgroundBuffer, headline, pathways, wordmark, bottomBar }) {
  ...
  const base = await sharp(backgroundBuffer)
    ...
    .toBuffer();
  const overlay = buildOverlaySvg({ headline, pathways, wordmark, bottomBar });
  return sharp(base)
...
module.exports = { WIDTH, HEIGHT, splitHeadline, buildOverlaySvg, composeCreative };
