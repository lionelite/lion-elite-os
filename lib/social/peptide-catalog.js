...
const VISUAL_BASE =
  'Premium product photograph of a single small glass research vial with a ' +
  'minimal black-and-gold Lion Elite Wellness style label, studio lighting, ' +
  'dark gradient background, sharp macro focus, luxury pharmaceutical-grade ' +
  'aesthetic, no text overlays, no claims, portrait 4:5 composition';
...
const PEPTIDE_CATALOG = Object.freeze([
  ...
  imagePrompt: `${VISUAL_BASE}. Vial concept: ${entry.name}.`
})));
