 ...
 * dense typography.
 */
function buildBackgroundPrompt({ name, flair, format = 'vertical 4:5, 1080x1350' }) {
  return [
    ...
    'Composition: keep the LEFT THIRD and a strip along the BOTTOM as clean, darker, low-detail negative space for text overlay. The lion and vial occupy the right and center.',
    'Palette: deep black/charcoal, metallic gold (#C9A24B), warm savanna amber. Mood: premium, authoritative, editorial.',
    'IMPORTANT: render NO headline text, NO paragraph text, NO icons, NO logos, NO captions anywhere — only the photographic scene and the vial. Text is added separately.'
  ].join(' ');
}
