...
The engine always excludes matches marked `doNotEngage`, deduplicates by Bluesky DID/post/audience, logs every delivery attempt, and stops immediately when `BLUESKY_OUTREACH_ENABLED` is not `true`.
